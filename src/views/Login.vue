<template>
  <div class="page full-fixed row flex-column center">
      ...
      <div class="row flex-column hfulli">
        ...
        <div class="col">
          ...
          <div class="row hfulli align-items-center">
            ...
            <div class="col-4">
              <btn tag="a" class="theme fs20i" @tap="applyNumber('1')">1</btn>
            </div>
            <div class="col-4">
              <btn tag="a" class="theme fs20i" @tap="applyNumber('2')">2</btn>
            </div>
            <div class="col-4">
              <btn tag="a" class="theme fs20i" @tap="applyNumber('3')">3</btn>
            </div>
        ...
        <div class="col">
          ...
          <div class="row hfulli align-items-center">
            ...
            <div class="col-4">
              <btn tag="a" class="theme fs20i" @tap="applyNumber('4')">4</btn>
            </div>
            <div class="col-4">
              <btn tag="a" class="theme fs20i" @tap="applyNumber('5')">5</btn>
            </div>
            <div class="col-4">
              <btn tag="a" class="theme fs20i" @tap="applyNumber('6')">6</btn>
            </div>
        ...
        <div class="col">
          ...
          <div class="row hfulli align-items-center">
            ...
            <div class="col-4">
              <btn tag="a" class="theme fs20i" @tap="applyNumber('7')">7</btn>
            </div>
            <div class="col-4">
              <btn tag="a" class="theme fs20i" @tap="applyNumber('8')">8</btn>
            </div>
            <div class="col-4">
              <btn tag="a" class="theme fs20i" @tap="applyNumber('9')">9</btn>
            </div>
        ...
        <div class="col">
          ...
          <div class="row hfulli align-items-center">
            ...
            <div class="col-4"></div>
            <div class="col-4">
              <btn tag="a" class="theme fs20i" @tap="applyNumber('0')">0</btn>
            </div>
            <div class="col-4">
              <btn tag="a" class="theme fs20i" @tap="applyNumber('C')">C</btn>
            </div>
  ...
  methods: {
    ...
    sendPhoneNumber() {
      ...
      this.$stiller.firebase.auth.signInWithPhoneNumber({ number: this.country_code + this.phone_number })
        ...
        .catch(error => { this.$router.replace('/unauthorized') })
